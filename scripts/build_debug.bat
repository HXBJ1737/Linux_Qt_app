...
cd build
qmake.exe %PRO_DIR%\app2025.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=console"
if exist %BUILD_DIR%\debug\app2025.exe del %BUILD_DIR%\debug\app2025.exe
