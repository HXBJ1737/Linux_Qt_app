...
"background-color: rgb(9, 9, 9);"));
        ...
        openbtn->setGeometry(QRect(670, 80, 101, 31));
        QFont font;
...
"color: rgb(22, 37, 63);"));
        ...
        closebtn->setGeometry(QRect(670, 140, 101, 31));
        closebtn->setFont(font);
        closebtn->setStyleSheet(QString::fromUtf8("background-color: rgb(195, 188, 230);\n"
"color: rgb(22, 37, 63);"));
...
"border-radius:40px;"));
        ...
        camBackBtn->setGeometry(QRect(670, 20, 101, 41));
...
"color: rgb(22, 37, 63);"));
    ...
    void retranslateUi(QMainWindow *cam)
    {
        ...
        openbtn->setText(QCoreApplication::translate("cam", "1", nullptr));
        closebtn->setText(QCoreApplication::translate("cam", "2", nullptr));
