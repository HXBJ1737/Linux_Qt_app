...
"max-height: 100px;"));
        ...
        gridLayout->addWidget(poweroff_pushButton, 0, 5, 1, 1);
...
"max-height: 100px;"));
        ...
        gridLayout->addWidget(close_btn, 0, 8, 1, 1);
...
""));
        ...
        gridLayout->addWidget(test_pushButton, 1, 0, 1, 1);
...
""));
        ...
        gridLayout->addWidget(reboot_pushButton, 0, 9, 1, 1);
